...
gulp.task('compile', ['clean'], function() {
    return browserify('./lib/bespoke-analytics.js')
        .exclude('bespoke-convenient')
        .exclude('bespoke-ga')
        .bundle({
            standalone: 'bespoke.plugins.analytics'
        })
        .pipe(source('bespoke-analytics.js'))
        .pipe(buffer())
        ...
        .pipe(gulp.dest('dist'))
        .pipe(rename('bespoke-analytics.min.js'))
        .pipe(uglify())
        .pipe(header(template([
            '/*! <%= name %> v<%= version %> ',
